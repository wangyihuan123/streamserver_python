...
class TkinterGuiController(ThreadedController):
    ...
    def __init__(self):
        ...
        self.startButton = ttk.Button(self.content_frame, text="Start Recording", style='B1.TButton',command=self.start_recording)
        self.startButton.grid(row=2, column=0,  padx=5, pady=25, sticky='se')


        self.stopButton = ttk.Button(self.content_frame, text="Stop Recording", style='B1.TButton',command=self.stop_recording)
